...
function FlightCard({ flight, isList }: Props) {
  ...
  return (
    <div className="my-2 relative group transition-all duration-300 max-md:w-[100%] w-[90%]">
      <FlightActionsButton flight={flight} />
      <button
        className={`flex flex-col bg-white dark:bg-neutral-800 text-black dark:text-white p-5 rounded-2xl gap-7 hover:border-3 hover:border-amber-400 transition-all duration-50 w-[100%] ${

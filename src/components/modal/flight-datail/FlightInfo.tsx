...
export function FlightInfo({flight}: Props) {
  return <div className="flight_info_block">
          <div className="flight_info">
            <div className="from ">
              <span className="code">{flight.flightInfo.fromCode}</span>
              <span className="town">{flight.flightInfo.from}</span>
              <span className="flight_timestamp">{flight.flightInfo.fromTimestamp}</span>
            </div>
            ...
            <div className="to">
              ...
              <span className="flight_timestamp">{flight.flightInfo.toTimestamp}</span>
            </div>
          </div>
